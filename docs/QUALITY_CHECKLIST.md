...
| ID | 검토 내용 | 누가 |
|---|---|---|
| H-01 | 법령 인용과 교육용 FAQ의 해석이 정확하다. Day 1은 교육용 가상 규정·FAQ·기대 답변이 서로 일치하고, 가상 규정이 실제 법령 원문으로 오해되지 않게 표기되었다(CD-21) | Day 1: 강사 본인(OQ-12 해결). Day 2 키트: OQ-21 결정 때 함께 정한다 |
