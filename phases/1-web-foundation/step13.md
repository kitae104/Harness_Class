...
개념형 기준 예시 D1-01(`d1-harness-intro`)이 **사람의 승인을 받았는지 확인하는 관문**이다. step 8~12에서 첫 사람 검토 결과(루브릭 1·1·2·1)에 따라 규칙과 D1-01을 보완했다. 이 step은 아무것도 만들거나 고치지 않는다. 승인되지 않았으면 사람에게 무엇을 해야 하는지 알려 주고 멈춘다.
...
1. 위 AC 커맨드를 실행한다.
2. 결과에 따라 `phases/1-web-foundation/index.json`의 step 13을 업데이트한다:
